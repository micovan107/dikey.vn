        ...
        for (const post of posts) {
            ...
            if (post.comments) {
                for (const commentId in post.comments) {
                    ...
                    const commentAuthorData = await fetchUserData(comment.authorId);
                    ...
                    commentsHTML += `
                        <div class="comment">
                            <a href="wall.html?id=${comment.authorId}">
                                <img src="${commentAuthorAvatar}" alt="Avatar" class="comment-avatar">
                            </a>
                            <div class="comment-content">
                                <p><strong><a href="wall.html?id=${comment.authorId}">${commentAuthorName}</a>:</strong> ${comment.text}</p>
